         ...
         <tr style="border-collapse:collapse;"> 
          <td align="center" style="padding:0;Margin:0;"> 
           <table class="es-content-body" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:transparent;" width="600" cellspacing="0" cellpadding="0" align="center"> 
			...
			<p>Hi {{ $name }},</p>
			<p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;">The status of the following task has just changed to " {{$status}} " and you wanted us to let you know:
                        </p>
                        </br>
                        <p><b>{{$title}}</b></p>
                        </br>
                        <p>Please note that if you can change the notification schedule for each task in DidYu. Yo can select tp either:</p>
                        </br>
                        <p>1. Advise you when the status of a task is "Overdue"</p>
                        <p>2. Advise you when an important task's status changes to "Complete" e.g Payroll</p>
                        <p>3. Make notifications inactive for a task</p>
                        </br>
                        <p>To change the notification schedule for a task, log in to DidYu, select the task and select the appropriate tick boxes in the top right-hand side of the edit screen.</p>
                        </br>
                     ...
                     <tr style="border-collapse:collapse;"> 
                      <td class="es-m-txt-l" align="left" style="Margin:0;padding-top:20px;padding-left:30px;padding-right:30px;padding-bottom:40px;"> 
                        <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;">From the DidYu&nbsp;Team.--</p>
                        <p>Gav.</p></p> </td> 
                     </tr> 
                   </table> </td> 
                 </tr> 
